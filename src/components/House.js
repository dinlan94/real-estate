...
const House = ({ house }) => {
  ...
  return (
    <div className='bg-white shadow-1 p-5 rounded-lg rounded-tl-[90px] w-full max-w-[352px] max-h-[550px] mx-auto
    cursor-pointer hover:shadow-2xl transition'>
      ...
      <div className='text-lg font-semiboldmax-w-[260px]'>{address}</div>
